      ...
      <div className="max-w-4xl w-full mx-auto bg-white rounded-3xl overflow-hidden border border-stone-200 shadow-sm flex flex-col md:flex-row">
        ...
        <div className="md:w-1/2 p-8 flex flex-col justify-between bg-white">
           ...
           <div className="space-y-3 pt-6 border-t border-stone-100">
              ...
              <button onClick={handleContact} disabled={actionLoading} className="w-full bg-stone-900 text-white p-4 rounded-2xl font-black uppercase text-[10px] tracking-widest hover:bg-stone-700 transition-all shadow-md">
      ...
      {showCoffeeModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-stone-900/60 backdrop-blur-sm">
          <div className="bg-white max-w-sm rounded-3xl p-8 shadow-2xl relative text-center">
            ...
            <p className="text-xs text-stone-600 mb-8">Hai appena trovato un oggetto gratuito! Se ti va, offrici un caffè (2.50€) per aiutarci a mantenere la piattaforma.</p>
